...
function Newemployeeform() {
    ...
    function SubmitHandler(event){
        ...
        const entered_reg = reg_input_ref.current.value;
    ...
    return (
      <Card>
        ...
        <div className={classes.control}>
            <label htmlFor='Reg'>Employee Reg_no</label>
            <input type='text' required id='reg' ref = {reg_input_ref} />
          </div>
          <div className={classes.control}>
